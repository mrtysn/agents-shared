---
name: apple-design
description: Apple's approach to fluid, physical motion, translated for the web. Use when building or reviewing gesture-driven UI, spring animations, drag/swipe/sheet interactions, momentum and interruptible transitions, translucent materials and depth, or reduced-motion behaviour behind Apple-style interfaces. Typography and layout questions belong to the interface group.
# LOCAL: description narrowed to gestures, springs, momentum and materials so it does not fire on typography or layout questions (interface group owns those)
---
