...
- After writing plans, create or update <!-- LOCAL: animation-plans/ -->`animation-plans/README.md`<!-- LOCAL END --> with: a table of plans (number, title, severity, status), the recommended execution order, and any dependencies between plans.
