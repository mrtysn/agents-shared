...
---
<!-- LOCAL: disable-model-invocation added above. The router skill carries the trigger
surface for this group, so this description need not load into every session. -->
