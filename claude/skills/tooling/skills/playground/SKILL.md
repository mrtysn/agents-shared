...
<!-- LOCAL: no `open` (focus policy); print the absolute path instead -->
4. **Hand it over.** After writing the HTML file, print its absolute path on its own line. Do not run `open`; the user opens it themselves.
<!-- LOCAL END -->
